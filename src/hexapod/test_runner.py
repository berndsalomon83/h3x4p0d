...
def test_gait_engine():
    ...
    print(f"✓ GaitEngine: all modes, time progression")
...
def test_gait_synchronization():
    ...
    tripod_angles = gait.joint_angles_for_time(0.0, mode="tripod")
    # All legs should have non-identical positions, but in groups
    
    # Wave: smooth progression 0..5/6
    wave_angles = gait.joint_angles_for_time(0.0, mode="wave")
    
    # Ripple: mixed phases
    ripple_angles = gait.joint_angles_for_time(0.0, mode="ripple")
